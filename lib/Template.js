...
module.exports = {
    ...
    table: function(columns) {
        ...
        for(column in columns) {
            ...
            table += `<tr><td>${columns[column].calen}</td><td>${type}</td><td>${columns[column].title}</td><td>${columns[column].price}</td><td><a href='/update?id='>수정</a></td><td><input type='submit' value='삭제'></td></tr>`
        }
